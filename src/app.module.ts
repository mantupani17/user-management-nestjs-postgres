...
import { Module as ModuleEntity, RoleModulePermission, User, Permission, Role, Document as DocumentEntity, TrackIngestion, IngestionData } from './entities'
...
@Module({
  ...
  providers: [ AppService, JwtService, JwtStrategy, JwtAuthGuard, AbilityService, CaslGuard, IngTrackSchedulerService, AxiosService, PhotosApisService, UserService, CryptoService, RolesService, SeederService ],
})
